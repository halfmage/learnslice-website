const services = [
    {
        ...
        description: "Learnslice bindet Auszubildende ein, erweitert ihr Wissen, fördert die Loyalität und senkt gleichzeitig die Abbrecherquoten, wodurch die Investitionen des Unternehmens in die Ausbildung maximiert werden.",
    ...
    },
    {
        ...
        description: "Learnslice passt Inhalte individuell an Ihre Auszubildenden an, wodurch das Verständnis und die Behaltensleistung gefördert werden, was wiederum zu besseren Prüfungsergebnissen und der Entwicklung eines kompetenten und kenntnisreichen Teams führt.",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
        </svg>`,
    },
    {
        title: "Umfassende Unterstützung",
        description: "Learnslice bietet umfassende Unterstützung für Mentoren, die alles vom Onboarding bis zur Prüfungsvorbereitung abdeckt und den Auszubildenden die notwendigen Fähigkeiten für ihr berufliches Wachstum in Ihrem Unternehmen vermittelt.",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
        </svg>`,
    },
];
